...
function DraftSimulatorContent() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          <div className="lg:col-span-4 space-y-4">
            <div className="bg-blue-950/20 border border-blue-900/50 rounded-2xl p-4 flex items-center justify-between">
              <div> 
                <p className="text-blue-500 text-[10px] font-black uppercase tracking-widest mb-1">Blue Side</p> 
                <button onClick={() => setShowTeamModal('blue')} className="text-2xl font-black italic uppercase text-white hover:text-blue-400"> 
                  {blueTeam || '+ ELEGIR EQUIPO'} 
                </button> 
              </div>
            </div>
          ...
          {/* LADO ROJO */}
          <div className="lg:col-span-4 space-y-4">
            <div className="bg-red-950/20 border border-red-900/50 rounded-2xl p-4 flex items-center justify-between text-right"> 
              <Shield size={24} className="text-red-500 opacity-50" /> 
              <div> 
                <p className="text-red-500 text-[10px] font-black uppercase tracking-widest mb-1">Red Side</p> 
                <button onClick={() => setShowTeamModal('red')} className="text-2xl font-black italic uppercase text-white hover:text-red-400"> 
                  {redTeam || '+ ELEGIR EQUIPO'} 
                </button> 
              </div> 
            </div>
            <div className="space-y-2">
