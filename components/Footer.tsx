...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-[#1a1a1a] bg-black py-8 mt-10">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center md:items-start gap-6">
        ...
        <div className="text-center max-w-sm">
          <p className="text-[#444] text-[9px] uppercase tracking-wider leading-relaxed">
            Datos de planteles y recursos gráficos provistos por la comunidad de{' '}
            <a 
              href="https://www.thesportsdb.com/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-[#666] hover:text-[#10b981] underline decoration-[#333] transition-colors"
            >
              TheSportsDB
            </a>.
          </p>
